...
const exportThreeGeometry = (geometry) => {
    ...
    threeGeometry.addAttribute('position', new THREE.BufferAttribute(new Float32Array(vertices), 3)); // eslint-disable-line no-undef
    if (colorsUsed) threeGeometry.addAttribute('color', new THREE.BufferAttribute(new Float32Array(colors), 3)); // eslint-disable-line no-undef
