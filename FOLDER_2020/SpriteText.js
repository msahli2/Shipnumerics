...
THREE.SpriteText = function ( text, options ) {
	...
	options.displayRect = options.displayRect || false;
	...
	options.displayRect = new options.cookie( 'displayRect' ).isTrue( options.displayRect );
